...
You can also extract observations "near" a certain value but you need to specify a tolerance.  Range between 1.8-2.2
```{r}
...
```{r}
mammals_n <- select(mammals, - "family", "genus", "species", "mass", "gestation")
mammals_n
