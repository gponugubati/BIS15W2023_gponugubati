...
```{r}
here() #useful when you have a lot of folders and files; points to one file specifically
```
...
```{r}
relig_income #The income values are also data, but here they are column names
```
...
```{r}
plant_data #The days are also values, not column names
```
