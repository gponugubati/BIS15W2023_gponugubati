...
**Make sure to indicate characters by using quotations**
...
box_office
```
**makes vector of all the vectors**
...
harry_potter_matrix
```
**data matrix of all the box office vectors**
